...
- 9f840e6 — dedup batch:- b5b3745 — stdlib twins removed (net.JoinHostPort, strconv.Atoi). NEXT UP (found via hidden-bug checklist): auto-tunnel should skip spawn when device reports iOS < 17 (DDI territory, not CoreDevice) — pure predicate + table test, wire into GoIOS.tunnelReady.
