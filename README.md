...
(the same pure-Go talk-to-Apple stack as the Mach-O tooling). The
...
- **Faithful package conversion** — the converters are ports of the ecosystem's own tools ([rootless-patcher](https://github.com/NightwindDev/rootless-patcher), [RootHidePatcher](https://github.com/roothide/RootHidePatcher)), pinned byte-for-byte against upstream output.
